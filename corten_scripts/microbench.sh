...
run_microbench "/test/scale/mmap unfixed"
run_microbench "/test/scale/mmap fixed 1"
run_microbench "/test/scale/mmap fixed 2"
run_microbench "/test/scale/mmap_pf unfixed"
run_microbench "/test/scale/mmap_pf fixed 1"
run_microbench "/test/scale/mmap_pf fixed 2"
run_microbench "/test/scale/pf one_vma 0"
run_microbench "/test/scale/pf one_vma 1"
run_microbench "/test/scale/pf one_vma 2"
run_microbench "/test/scale/munmap_virt one_vma 0"
run_microbench "/test/scale/munmap_virt one_vma 1"
run_microbench "/test/scale/munmap_virt one_vma 2"
run_microbench "/test/scale/munmap one_vma 0"
run_microbench "/test/scale/munmap one_vma 1"
run_microbench "/test/scale/munmap one_vma 2"
